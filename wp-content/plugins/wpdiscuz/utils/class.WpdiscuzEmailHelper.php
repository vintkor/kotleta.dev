...
class WpdiscuzEmailHelper {
    ...
    public function addSubscription() {
        ...
        $httpReferer .= $wp_rewrite->using_permalinks() ? "?subscribeAnchor&subscriptionSuccess=$success&email=$email#wc_unsubscribe_message" : "&subscribeAnchor&subscriptionSuccess=$success#wc_unsubscribe_message";
