...
<div>
    ...
    <table class="wp-list-table widefat plugins" style="margin-top:10px; border:none;">
        <tbody>
            ...
            <tr valign="top">
                <th scope="row"><label for="wc_captcha_show_hide"><?php _e('Hide the CAPTCHA field for guests', 'wpdiscuz'); ?></label></th>
                <td><input type="checkbox" <?php checked($this->optionsSerialized->captchaShowHide == 1) ?> value="1" name="wc_captcha_show_hide" id="wc_captcha_show_hide" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="wc_captcha_show_hide_for_members"><?php _e('Show the CAPTCHA field for logged in users', 'wpdiscuz'); ?></label></th>
                <td><input type="checkbox" <?php checked($this->optionsSerialized->captchaShowHideForMembers == 1) ?> value="1" name="wc_captcha_show_hide_for_members" id="wc_captcha_show_hide_for_members" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="wc_weburl_show_hide"><?php _e('Show the Website URL field', 'wpdiscuz'); ?></label></th>
                <td><input type="checkbox" <?php checked($this->optionsSerialized->weburlShowHide == 1) ?> value="1" name="wc_weburl_show_hide" id="wc_weburl_show_hide" /></td>
            </tr>
            <tr valign="top">
