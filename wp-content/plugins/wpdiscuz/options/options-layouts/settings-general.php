...
<div>
    ...
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>
            <tr valign="top">
                <th scope="row" style="width:55%;"><?php _e('Display comment form for post types', 'wpdiscuz'); ?></th>
                <td>                                
                    <?php
            ...
            <tr valign="top">
                <th scope="row"><label for="wc_quick_tags"><?php _e('Enable Quicktags', 'wpdiscuz'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row"><label for="wc_is_email_field_required"><?php _e('Comment author must fill out email', 'wpdiscuz'); ?></label></th>
                <td><input type="checkbox" <?php checked($this->optionsSerialized->isEmailFieldRequired == 1) ?> value="1" name="wc_is_email_field_required" id="wc_is_email_field_required" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="wc_is_name_field_required"><?php _e('Comment author must fill out name', 'wpdiscuz'); ?></label></th>
                <td><input type="checkbox" <?php checked($this->optionsSerialized->isNameFieldRequired == 1) ?> value="1" name="wc_is_name_field_required" id="wc_is_name_field_required" /></td>
            </tr>
            <tr valign="top">
                <th scope="row">
